...
def main():
    ...
    files_to_upload_no_sort = [
        'C:\\Users\\mount\\Git\\StockAnalysis_Technical\\VolumeAnalysis\\output\\all_industries_volume_ma.csv', # 出来高移動平均情報
        'C:\\Users\\mount\\Git\\StockAnalysis_Technical\\VolumeAnalysis\\output\\industries_volume_above_ma.csv', # 出来高移動平均情報(短期＞長期)
        'C:\\Users\\mount\\Git\\StockAnalysis_Technical\\VolumeAnalysis\\output\\industries_volume_below_ma.csv', # 出来高移動平均情報(短期＜長期)
    ]
